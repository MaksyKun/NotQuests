...
public class RandomNumberBetweenRangeVariable extends Variable<Integer> {
  public RandomNumberBetweenRangeVariable(NotQuests main) {
    super(main);
    addRequiredNumber(NumberVariableValueParser.numberVariableValueParser("min", null, null));
    addRequiredNumber(NumberVariableValueParser.numberVariableValueParser("max", null, null));
  }
