    ...
    public static void handleCommands(
        ...
        for (final String variableString : main.getVariablesManager().getVariableIdentifiers()) {
            ...
            manager.command(main.getVariablesManager().registerVariableCommands(variableString, builder)
                    ...
                    .required("expression", booleanVariableValueParser("expression", null, null), Description.of("Expression"))
                    .handler(
                            (context) -> {
                                ...
                                for (CustomStringParser stringParser :
                                        variable.getRequiredStrings()) {
                                    additionalStringArguments.put(
                                            stringParser.getIdentifier(), context.get(stringParser.getIdentifier()));
                                }
